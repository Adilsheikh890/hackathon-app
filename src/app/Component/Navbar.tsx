...
const Navbar=()=> {
  ...
  return (
    ...
    <div className="  flex px-3 py-4 md:pl-20 pl-10 justify-between sticky top-0 backdrop-blur-lg bg-gradient-to-tr from-white via-[#ffffffde] to-opacityDownColor md:z-20">
    ...
    <div className="   ">
     ...
     <div className="flex md:pl-80   rounded-xl relative  items-center justify-center  ">
        <div className="w-4 h-4 absolute  top-0  bottom-10 right-0 bg-red-400 text-xs font-light rounded-full flex justify-center">3</div>
